...
Blarich_pr
dev.new(width=24,height=16,dpi=80,pointsize=20,noRStudioGD = T)
...
Ararich_pr
plot(1:4,Ararich_pr$fit,ylim=c(1,2.6),type='p',pch=c(20,18,20,18),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Probability of Occurence',xlab='',main='Araneae Richness',font.main=1)
legend("bottomleft", legend=c("Control", "Rock"), pch = c(20,18), cex=1, box.lty=0)
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
...
Colrich_pr
plot(1:4,Colrich_pr$fit,ylim=c(1,2.6),type='p',pch=c(20,18,20,18),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Probability of Occurence',xlab='',main='Coleoptera Richness',font.main=1)
legend("bottomleft", legend=c("Control", "Rock"), pch = c(20,18), cex=1, box.lty=0)
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
...
Formrich_pr
plot(1:4,Formrich_pr$fit,ylim=c(1,2.6),type='p',pch=c(20,18,20,18),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Probability of Occurence',xlab='',main='Formicidae Richness',font.main=1)
legend("bottomleft", legend=c("Control", "Rock"), pch = c(20,18), cex=1, box.lty=0)
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
