...
#6 Other (Other invertebrates) - identified to Order only, does not include Hemiptera, or Hymenoptera
...
Ara2 <- Araneae[,c(-5)]
Ara_summ <- Ara2 %>% group_by(Year,Site,Treatment,Plot) %>% summarise_all(sum)
...
Bla2 <- Blattodea[,c(-5)]
Bla_summ <- Bla2 %>% group_by(Year,Site,Treatment,Plot) %>% summarise_all(sum)
...
Col_summ <- Col2 %>% group_by(Year,Site,Treatment,Plot) %>% summarise_all(sum)
...
Form_summ <- Form2 %>% group_by(Year,Site,Treatment,Plot) %>% summarise_all(sum)
...
Ort_summ <- Ort2 %>% group_by(Year,Site,Treatment,Plot) %>% summarise_all(sum)
...
Other_summ <- Other2 %>% group_by(Year,Site,Treatment,Plot) %>% summarise_all(sum)
...
#Abundance ----
abundance <- read.csv("Data/Abundance.csv",header=T)
abundance$Morphospecies <- factor(abundance$Morphospecies)

Ara <- data.frame(subset (abundance, Order=='Araneae'))
Ara <- Ara[order(Ara$Change),]
Ara <-tidy.df(Ara)

Col <- data.frame(subset (abundance, Order=='Coleoptera'))
Col <- Col[order(Col$Change),]
Col <-tidy.df(Col)

Form <- data.frame(subset (abundance, Order=='Formicidae'))
Form <- Form[order(Form$Change),]
Form <-tidy.df(Form)

Blat <- data.frame(subset (abundance, Order=='Blattodea'))
Blat <- Blat[order(Blat$Change),]
Blat <-tidy.df(Blat)

Ort <-data.frame(subset (abundance, Order=='Orthoptera'))
Ort <- Ort[order(Ort$Change),]
Ort <-tidy.df(Ort)

Oth <- data.frame(subset (abundance, Order=='Other'))
Oth <- Oth[order(Oth$Change),]
Oth <-tidy.df(Oth)

dev.new(width=33,height=39,dpi=100,pointsize=20,noRStudioGD = T)
layout(matrix(c(1,2,3,1,2,3,4,5,6), 3, 3, byrow=TRUE))
par(mar=c(5,5,1,1),mgp=c(1.9,1,0),oma=c(0,0,1.5,0))
d1 <- dotchart(Ara$Change,labels=NULL, cex=0.7, pch=20, col=ifelse(sign(Ara$Change)==-1,'red',ifelse(sign(Ara$Change)==0, 'black', 'chartreuse3')), xlab= "Change in Abundance", xaxt='n')
title (mtext("(a) Araneae", side=3, adj=0, line=0.8, cex=0.7, font=1))
arrows(x0=0, y0=1, x1=0, y1=length(Ara$Morphospecies),length = 0.01,code = 3)
axis(side=2, at=1:length(Ara$Morphospecies),labels=Ara$Morphospecies,tick = F,cex.axis=0.4,line=-0.5,las=1)
axis(side=1, at=d1, labels = TRUE, cex.axis =0.65, mgp=c(3,0.7,0))
dotchart(Col$Change,labels=NULL, cex=0.7, pch=20, col=ifelse(sign(Col$Change)==-1, 'red', ifelse(sign(Col$Change)==0, 'black', 'chartreuse3')), xlab= "Change in Abundance", xaxt='n')
title (mtext("(b) Coleoptera", side=3, adj=0, line=0.8, cex=0.7, font=1))
arrows(x0=0, y0=1, x1=0, y1=length(Col$Morphospecies),length = 0.01,code = 3)
axis(side=2, at=1:length(Col$Morphospecies),labels=Col$Morphospecies,tick = F,cex.axis=0.4,line=-0.5,las=1)
axis(side=1, at=d1, labels = TRUE, cex.axis =0.65, mgp=c(3,0.7,0))
dotchart(Form$Change,labels=NULL, cex=0.7, pch=20, col=ifelse(sign(Form$Change)==-1, 'red', ifelse(sign(Form$Change)==0, 'black', 'chartreuse3')), xlab= "Change in Abundance", xaxt='n')
title (mtext("(c) Formicidae", side=3, adj=0, line=0.8, cex=0.7, font=1))
arrows(x0=0, y0=1, x1=0, y1=length(Form$Morphospecies),length = 0.01,code = 3)
axis(side=2, at=1:length(Form$Morphospecies),labels=Form$Morphospecies,tick = F,cex.axis=0.4,line=-0.5,las=1)
axis(side=1, at=d1, labels = TRUE, cex.axis =0.65, mgp=c(3,0.7,0))
dotchart(Blat$Change,labels=NULL, cex=0.7, pch=20, col=ifelse(sign(Blat$Change)==-1, 'red', ifelse(sign(Blat$Change)==0, 'black', 'chartreuse3')), xlab= "Change in Abundance", xaxt='n')
title (mtext("(d) Blattodea", side=3, adj=0, line=0.8, cex=0.7, font=1))
arrows(x0=0, y0=1, x1=0, y1=length(Blat$Morphospecies),length = 0.01,code = 3)
axis(side=2, at=1:length(Blat$Morphospecies),labels=Blat$Morphospecies,tick = F,cex.axis=0.4,line=-0.5,las=1)
axis(side=1, at=d1, labels = TRUE, cex.axis =0.65, mgp=c(3,0.7,0))
dotchart(Ort$Change,labels=NULL, cex=0.7, pch=20, col=ifelse(sign(Ort$Change)==-1, 'red', ifelse(sign(Ort$Change)==0, 'black', 'chartreuse3')), xlab= "Change in Abundance", xaxt='n')
title (mtext("(e) Orthoptera", side=3, adj=0, line=0.8, cex=0.7, font=1))
arrows(x0=0, y0=1, x1=0, y1=length(Ort$Morphospecies),length = 0.01,code = 3)
axis(side=2, at=1:length(Ort$Morphospecies),labels=Ort$Morphospecies,tick = F,cex.axis=0.4,line=-0.5,las=1)
axis(side=1, at=d1, labels = TRUE, cex.axis =0.65, mgp=c(3,0.7,0))
dotchart(Oth$Change,labels=NULL, cex=0.7, pch=20, col=ifelse(sign(Oth$Change)==-1, 'red', ifelse(sign(Oth$Change)==0, 'black', 'chartreuse3')), xlab= "Change in Abundance", xaxt='n')
title (mtext("(f) Other", side=3, adj=0, line=0.8, cex=0.7, font=1))
arrows(x0=0, y0=1, x1=0, y1=length(Oth$Morphospecies),length = 0.01,code = 3)
axis(side=2, at=1:length(Oth$Morphospecies),labels=Oth$Morphospecies,tick = F,cex.axis=0.4,line=-0.5,las=1)
axis(side=1, at=d1, labels = TRUE, cex.axis =0.65, mgp=c(3,0.7,0))
...
plot(1:4,Blarich_pr$fit,ylim=c(0,1),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Probability of Occurence',xlab='Year')
...
bp2 <- ifelse(bp1<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')),as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Blarich_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('topright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Blarich_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(bp2),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Blarich_mod1)$coefficients[4,'Pr(>|z|)'],3))))),pch="", adj = 0,bty = 'n')
plot(1:4,Ortrich_pr$fit,ylim=c(0,1),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Probability of Occurence',xlab='Year')
...
orp2 <- ifelse(orp1<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')),as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Ortrich_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('bottomright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Ortrich_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(orp2),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Ortrich_mod1)$coefficients[4,'Pr(>|z|)'],3))))),pch="", adj = 0,bty = 'n')
plot(1:4,Otherrich_pr$fit,ylim=c(0,1),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Probability of Occurence',xlab='Year')
...
op2 <- ifelse(op1<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')),as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Otherrich_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('bottomright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Otherrich_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(op2),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Otherrich_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
par(xpd=NA)
legend(x=5,y=0.8,legend = c("Control","Rock"), pch = c(1,19), cex=1, box.lty=0)
par(xpd=F)
...
legend('bottomright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Otherrich_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(op2),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Otherrich_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
par(xpd=NA)
legend(x=5,y=0.5,legend = c("Control","Rock"), pch = c(1,19), cex=1, box.lty=0)
par(xpd=F)
plot(1:4,Ararich_pr$fit.resp,ylim=c(min(Ararich_pr$lci.resp)-0.5,max(Ararich_pr$uci.resp)+0.5),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Species Richness',xlab='Year',main='Araneae',font.main=1)
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
...
ap2 <- ifelse(ap1<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Ararich_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('bottomleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Ararich_mod1)$coefficients[3,'Pr(>|z|)'],3)))),as.expression(ap2),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Ararich_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,Colrich_pr$fit.resp,ylim=c(min(Colrich_pr$lci.resp),max(Colrich_pr$uci.resp)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Species Richness',xlab='Year',main='Coleoptera',font.main=1)
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
...
cp2 <- ifelse(cp1<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')),as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Colrich_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Colrich_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(cp2),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Colrich_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,Formrich_pr$fit.resp,ylim=c(min(Formrich_pr$lci.resp),max(Formrich_pr$uci.resp)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Species Richness',xlab='Year',main='Formicidae',font.main=1)
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
...
fp2 <- ifelse(fp1<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')),as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Formrich_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Formrich_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(fp2),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Formrich_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
...
head(divinv_full,3);dim(divinv_full)
#write.table(divinv_full,"divinv_full_fresh.txt",sep='\t',quote=F,row.names=F)
...
col_c<-data.frame(Year=rep(unique(taxrich$Year)[order(unique(taxrich$Year))],rep(2,2)),Treatment=c('C','R'))
...
mm_col <- lm(Col_invdiv ~ Treatment+Yr+Treatment:Yr,data=divinv_full,x=T)$x
...
#Plotting diversity and richness for focus groups ----

dev.new(width=15,height=10,dpi=100,pointsize=20,noRStudioGD = T)
par(mfrow=c(2,3),mar=c(5,5,1,1),mgp=c(2.5,1,0),oma=c(0,0,2.5,5))
plot(1:4,Ararich_pr$fit.resp,ylim=c(min(Ararich_pr$lci.resp)-0.5,max(Ararich_pr$uci.resp)+0.5),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Species Richness',xlab='Year')
...
ap2 <- ifelse(ap1<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Ararich_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('bottomleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Ararich_mod1)$coefficients[3,'Pr(>|z|)'],3)))),as.expression(ap2),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Ararich_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,Colrich_pr$fit.resp,ylim=c(min(Colrich_pr$lci.resp),max(Colrich_pr$uci.resp)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Species Richness',xlab='Year')
...
cp2 <- ifelse(cp1<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')),as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Colrich_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Colrich_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(cp2),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Colrich_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,Formrich_pr$fit.resp,ylim=c(min(Formrich_pr$lci.resp),max(Formrich_pr$uci.resp)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Species Richness',xlab='Year')
...
legend(x=5,y=0.5,legend = c("Control","Rock"), pch = c(1,19), cex=1, box.lty=0)
par(xpd=F)
plot(1:4,Arainvdiv_pr$fit,ylim=c(min(Arainvdiv_pr$lci),max(Arainvdiv_pr$uci)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Species diversity',xlab='Year')
title (mtext("(d) Araneae diversity", side=3, adj=0, line=0.8, cex=0.75, font=1))
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
arrows(1:4,Arainvdiv_pr$lci,1:4,Arainvdiv_pr$uci,length=0.1,angle=90,code=3)
ap <- round(summary(Arainvdiv_mod1)$coefficients[3,'Pr(>|z|)'],3)
ap3 <- ifelse(ap<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')),as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Arainvdiv_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('topright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Arainvdiv_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(ap3),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Arainvdiv_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,Colinvdiv_pr$fit,ylim=c(min(Colinvdiv_pr$lci),max(Colinvdiv_pr$uci)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Species diversity',xlab='Year')
title (mtext("(e) Coleoptera diversity", side=3, adj=0, line=0.8, cex=0.75, font=1))
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
arrows(1:4,Colinvdiv_pr$lci,1:4,Colinvdiv_pr$uci,length=0.1,angle=90,code=3)
cp <- round(summary(Colinvdiv_mod1)$coefficients[3,'Pr(>|z|)'],3)
cp3 <- ifelse(cp<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')),as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Colinvdiv_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Colinvdiv_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(cp3),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Colinvdiv_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,Forminvdiv_pr$fit,ylim=c(min(Forminvdiv_pr$lci),max(Forminvdiv_pr$uci)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Species diversity',xlab='Year')
title (mtext("(f) Formicidae diversity", side=3, adj=0, line=0.8, cex=0.75, font=1))
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
arrows(1:4,Forminvdiv_pr$lci,1:4,Forminvdiv_pr$uci,length=0.1,angle=90,code=3)
fp <- round(summary(Forminvdiv_mod1)$coefficients[3,'Pr(>|z|)'],3)
fp3 <- ifelse(fp<0.001,expression(paste('Yr. '*(italic('P'))*'<'*'0.001')),as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(Forminvdiv_mod1)$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(Forminvdiv_mod1)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(fp3),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(Forminvdiv_mod1)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
...
dev.new(width=15,height=10,dpi=100,pointsize=20,noRStudioGD = T)
par(mfrow=c(2,3),mar=c(5,5,1,1),mgp=c(2.5,1,0),oma=c(0,0,2.5,5))
plot(1:4,arapca_pr$fit,ylim=c(min(arapca_pr$lci),max(arapca_pr$uci)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Principal component score',xlab='Year')
...
arap1 <- ifelse(arap<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(arapca2_mod1)$coefficients[3,'Pr(>|t|)'],3)))))
legend('bottomright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(arapca2_mod1)$coefficients[2,'Pr(>|t|)'],3)))),as.expression(arap1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(arapca2_mod1)$coefficients[4,'Pr(>|t|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,blapca_pr$fit,ylim=c(min(blapca_pr$lci),max(blapca_pr$uci)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Principal component score',xlab='Year')
...
blap1 <- ifelse(blap<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(blapca2_mod1)$coefficients[3,'Pr(>|t|)'],6)))))
legend('bottomleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(blapca2_mod1)$coefficients[2,'Pr(>|t|)'],3)))),as.expression(blap1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(blapca2_mod1)$coefficients[4,'Pr(>|t|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,colpca_pr$fit,ylim=c(min(colpca_pr$lci),max(colpca_pr$uci)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Principal component score',xlab='Year')
...
colp1 <- ifelse(colp<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(colpca2_mod1)$coefficients[3,'Pr(>|t|)'],6)))))
legend('bottomright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(colpca2_mod1)$coefficients[2,'Pr(>|t|)'],3)))),as.expression(colp1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(colpca2_mod1)$coefficients[4,'Pr(>|t|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
par(xpd=NA)
legend(x=5,y=5,legend = c("Control","Rock"), pch = c(1,19), cex=1, box.lty=0)
par(xpd=F)
plot(1:4,formpca_pr$fit,ylim=c(min(formpca_pr$lci),max(formpca_pr$uci)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Principal component score',xlab='Year')
...
formp1 <- ifelse(formp<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(formpca2_mod1)$coefficients[3,'Pr(>|t|)'],3)))))
legend('topright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(formpca2_mod1)$coefficients[2,'Pr(>|t|)'],3)))),as.expression(formp1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(formpca2_mod1)$coefficients[4,'Pr(>|t|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,ortpca_pr$fit,ylim=c(min(ortpca_pr$lci),max(ortpca_pr$uci)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Principal component score',xlab='Year')
...
ortp1 <- ifelse(ortp<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(ortpca2_mod1)$coefficients[3,'Pr(>|t|)'],3)))))
legend('bottomright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(ortpca2_mod1)$coefficients[2,'Pr(>|t|)'],3)))),as.expression(ortp1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(ortpca2_mod1)$coefficients[4,'Pr(>|t|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
plot(1:4,otherpca_pr$fit,ylim=c(min(otherpca_pr$lci),max(otherpca_pr$uci)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Principal component score',xlab='Year')
...
othp1 <- ifelse(othp<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(otherpca2_mod1)$coefficients[3,'Pr(>|t|)'],3)))))
legend('bottomright',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(otherpca2_mod1)$coefficients[2,'Pr(>|t|)'],3)))),as.expression(othp1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(otherpca2_mod1)$coefficients[4,'Pr(>|t|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
...
dev.new(width=15,height=10,dpi=100,pointsize=20,noRStudioGD = T)
par(mfrow=c(2,3),mar=c(5,5,1,1),mgp=c(2.5,1,0),oma=c(0,0,2.5,5))
plot(1:4,abetapred$fit.resp,ylim=c(0,max(abetapred$uci.resp)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Beta diversity',xlab='')
title (mtext("(a) Araneae", side=3, adj=0, line=0.8, cex=0.75, font=1))
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'),mgp=c(2,0.8,0))
...
betap1 <- ifelse(betap<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(abmod)$coefficients[3,'Pr(>|z|)'],3)))))
legend('bottomleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(abmod)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(betap1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(abmod)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
title(xlab='Year',mgp=c(2,0.8,0))
plot(1:4,cbetapred$fit.resp,ylim=c(0,max(cbetapred$uci.resp)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Beta diversity',xlab='')
...
betap1 <- ifelse(betap<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(cbmod)$coefficients[3,'Pr(>|z|)'],3)))))
legend('bottomleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(cbmod)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(betap1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(cbmod)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
title(xlab='Year',mgp=c(2,0.8,0))
plot(1:4,fbetapred$fit.resp,ylim=c(0,max(fbetapred$uci.resp)),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Beta diversity',xlab='')
...
betap1 <- ifelse(betap<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(fbmod)$coefficients[3,'Pr(>|z|)'],3)))))
legend('bottomleft',legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(fbmod)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(betap1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(fbmod)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
title(xlab='Year',mgp=c(2,0.8,0))
par(xpd=NA)
legend(x=5,y=15,legend = c("Control","Rock"), pch = c(1,19), cex=1, box.lty=0)
par(xpd=F)
i=1
bgroup.this.run<-beta_groups[i]
agroup.this.run<-alpha_groups[i]
...
#Create unique model matrix
umm_ara <- lm(dg_binom ~ Treatment+Yr+Treatment:Yr,data=ara_groups,x=T)$x
...
plot(1:4,snare_plot$fit.resp,ylim=c(0,max(snare_plot$uci.resp)+0.5),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Abundance',xlab='Year')
...
sp1 <- ifelse(sp1<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(snare_mod)$coefficients[3,'Pr(>|z|)'],3)))))
legend(x=0.25, y=2.7 ,legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(snare_mod)$coefficients[2,'Pr(>|z|)'],3)))),as.expression(sp1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(snare_mod)$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
text(x=1:4, y=max(snare_plot$uci.resp)+0.4,labels=c(rep("ab"),rep("ab"),rep(letters[c(1)],1),rep("b")))
par(xpd=NA)
legend(x=4.75, y=2.5, legend=c("Control", "Rock"), pch = c(1,19), cex=1.2, box.lty=0)
par(xpd=F)
...
#Put them in the natural order 2016-2019, c to r
...
plot(1:4,big_plot$fit.resp,ylim=c(0,max(big_plot$uci.resp)+0.5),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Abundance',xlab='Year')
...
bigp1 <- ifelse(bigp<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(formgroup_abun[[1]])$coefficients[3,'Pr(>|z|)'],3)))))
legend(x=0.25, y=9.5,legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(formgroup_abun[[1]])$coefficients[2,'Pr(>|z|)'],3)))),as.expression(bigp1),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(formgroup_abun[[1]])$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
text(x=1:4, y=max(big_plot$uci.resp)+0.4,labels=c(rep(letters[c(1)],2),rep(letters[c(2)],1),rep(letters[c(1)],1)))
par(xpd=NA)
legend(x=4.75, y=8.5, legend=c("Control", "Rock"), pch = c(1,19), cex=1.2, box.lty=0)
par(xpd=F)
...
axis(side=1,at=c(1.5,3.5),labels=c('2016','2019'))
arrows(1:4,big_plot$lci.resp,1:4,big_plot$uci.resp,length=0.05,angle=90,code=3)
bigp <- ifelse(bigp<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(formgroup_abun[[1]])$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',inset=0.05,legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(formgroup_abun[[1]])$coefficients[2,'Pr(>|z|)'],3)))),as.expression(bigp),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(formgroup_abun[[1]])$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
text(x=1:4, y=max(big_plot$uci.resp)+0.4,labels=c(rep(letters[c(1)],2),rep(letters[c(2)],1),rep(letters[c(1)],1)))
bigomn_plot<-formgroup_abpred[[14]]
plot(1:4,bigomn_plot$fit.resp,ylim=c(0,max(bigomn_plot$uci.resp)+0.5),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Abundance',xlab='Year')
...
bop <- ifelse(bop<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(formgroup_abun[[14]])$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',inset=0.05,legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(formgroup_abun[[14]])$coefficients[2,'Pr(>|z|)'],3)))),as.expression(bop),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(formgroup_abun[[14]])$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
...
plot(1:4,bigmix_plot$fit.resp,ylim=c(0,max(bigmix_plot$uci.resp)+0.5),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Abundance',xlab='Year')
...
bmxp <- ifelse(bmxp<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(formgroup_abun[[18]])$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',inset=0.05,legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(formgroup_abun[[18]])$coefficients[2,'Pr(>|z|)'],3)))),as.expression(bmxp),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(formgroup_abun[[18]])$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
text(x=1:4, y=max(bigmix_plot$uci.resp)+0.4,labels=c(rep(letters[c(1)],2),rep(letters[c(2)],1),rep(letters[c(1)],1)))

par(xpd=NA)
legend(x=5, y=6, legend=c("Control", "Rock"), pch = c(1,19), cex=1, box.lty=0)
par(xpd=F)

bigmany_plot<-formgroup_abpred[[24]]
plot(1:4,bigmany_plot$fit.resp,ylim=c(0,max(bigmany_plot$uci.resp)+0.5),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Abundance',xlab='Year')
...
bmp <- ifelse(bmp<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(formgroup_abun[[24]])$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',inset=0.05,legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(formgroup_abun[[24]])$coefficients[2,'Pr(>|z|)'],3)))),as.expression(bmp),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(formgroup_abun[[24]])$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
...
plot(1:4,bigcoop_plot$fit.resp,ylim=c(0,max(bigcoop_plot$uci.resp)+0.5),type='p',pch=c(1,19,1,19),xlim=c(0.5,4.5),las=1,cex=1.5,xaxt='n',ylab='Abundance',xlab='Year')
...
bcop <- ifelse(bcop<0.001,expression(paste('Yr. '*italic('P')*'<'*'0.001')), as.expression(bquote('Yr. '*italic('P')*'='*.(round(summary(formgroup_abun[[27]])$coefficients[3,'Pr(>|z|)'],3)))))
legend('topleft',inset=0.05,legend = c(as.expression(bquote('Treat. '*italic('P')*'='*.(round(summary(formgroup_abun[[27]])$coefficients[2,'Pr(>|z|)'],3)))),as.expression(bcop),as.expression(bquote('Int. '*italic('P')*'='*.(round(summary(formgroup_abun[[27]])$coefficients[4,'Pr(>|z|)'],3),sep='')))),pch="", adj = 0,bty = 'n')
